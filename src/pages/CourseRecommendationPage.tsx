                ...
                {primaryCourses.map((course, idx) => (
                  ...
                  >
                    <div className="relative z-10 flex flex-col items-center text-center">
                      ...
                      <h3 className="mb-3 text-xl font-semibold text-slate-100">{course.courseName}</h3>
                      <p className="mb-6 text-base leading-relaxed text-slate-400 line-clamp-3">
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="min-w-0 flex-1">
                      <div className="mb-2 flex items-center gap-2">
                        <span className="rounded-lg bg-slate-950/40 px-2 py-1 text-xs font-semibold text-slate-300 ring-1 ring-slate-800/70">
                          {getRiasecTypeName(selectedCourse.riasecType)}
                        </span>
                      </div>
                      <h2 className="text-2xl font-semibold text-slate-100">{selectedCourse.course.courseName}</h2>
                    ...
                    <div className="rounded-2xl border border-slate-800/70 bg-slate-950/30">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm font-semibold text-slate-200">What you'll learn</span>
                        </div>
                        <IconChevronDown
                          size={16}
                          className={cn(
                    ...
                    <div className="rounded-2xl border border-slate-800/70 bg-slate-950/30">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm font-semibold text-slate-200">Tools & skills</span>
                        </div>
                        <IconChevronDown
                          size={16}
                          className={cn(
