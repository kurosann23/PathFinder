    ...
    <div className="relative grid place-items-center" style={{ width: size, height: size }}>
      <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} className="block">
        ...
        <circle
          ...
          r={tickRadius}
          fill="transparent"
          stroke={isLight ? 'rgba(148,163,184,0.30)' : 'rgba(148,163,184,0.20)'}
          strokeWidth={2}
        ...
        <circle
          ...
          r={radius}
          fill="transparent"
          stroke={isLight ? 'rgba(148,163,184,0.25)' : 'rgba(148,163,184,0.16)'}
          strokeWidth={stroke}
        />
        ...
        <motion.circle
          ...
          style={{
            filter: isLight 
              ? 'drop-shadow(0px 0px 8px rgba(59,130,246,0.25))' 
              : 'drop-shadow(0px 0px 14px rgba(59,130,246,0.35))',
          }}
        />
        ...
        <circle
          ...
          cy={size / 2}
          r={radius - stroke * 1.2}
          fill={isLight ? 'rgba(255,255,255,0.8)' : 'rgba(2,6,23,0.28)'}
          stroke={isLight ? 'rgba(148,163,184,0.2)' : 'rgba(148,163,184,0.12)'}
          strokeWidth="1"
        />
      </svg>
      ...
      <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center text-center">
        <div
          className={cn('font-semibold tracking-tight', isLight ? 'text-blue-600' : 'text-slate-50')}
          style={{ fontSize: pctFontSize, lineHeight: 1.2 }}
        >
          {v}%
        </div>
        <div
          className={cn('mt-1.5 font-medium', isLight ? 'text-slate-700' : 'text-slate-300/80')}
